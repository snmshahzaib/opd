...
<html lang="en">
  ...
  <body>
    <div class="container-scroller">
      ...
      <div class="modal fade bd-example-modal-lg-update" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog" style="max-width:50%!important">
          <div class="modal-content" style="background-color: #191c24!important;">
            <div class="modal-header">
                ...
                <div class="card border-0">
                  <div class="card-body p-0 m-0">
                    ...
                    <form method="POST" action="" class="">
                      @csrf
                      <label class="">Department Title</label>
                      <input type="text" value="" name="title" class="form-control text-white mt-3" placeholder="Department Name">
